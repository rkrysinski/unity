...
public class SamlIdpProperties extends SamlProperties
{
	...
	static
	{
		...
		defaults.put(IGNORE_ATTRIBUTE_CONSUMING_SERVICE_INDEX, new PropertyMD("false").setCategory(samlCat).
				setDescription("If true then AttributeConsumingServiceIndex in SAML AuthnRequest is ignored."));
	...
	{
		return getBooleanValue(IGNORE_ATTRIBUTE_CONSUMING_SERVICE_INDEX);
	}
}
